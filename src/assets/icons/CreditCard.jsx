const CreditCard = ({ colorLight, colorDark, size = 24 }) => {
  return (
    <svg
      width={size || "24"}
      height={size || "24"}
    ...
    >
      <path
        ...
        fill={colorLight || "#3c2f2f"}
        fill-opacity="0.50"
      />
      <circle cx="6" cy="15" r="1" fill={colorDark || "#222222"} />
      <rect x="3" y="9" width="18" height="2" fill={colorDark || "#222222"} />
    </svg>
  );
};
